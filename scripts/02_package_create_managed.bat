...
SET packageName=Lightweight - LWC Util
...
REM Package Config
SET packageId=0HoP300000000WHKAY
SET packageVersionId=04tP3000000SkG1IAK
...
REM /packaging/installPackage.apexp?p0=04tP3000000SkG1IAK